...
const HeaderSection = () => {
  ...
  const IMAGE_DURATION = 12; // total duration per image
      ...
      <div className="max-w-7xl mx-auto px-4 flex flex-col md:flex-row items-center gap-10">
        ...
        <div className="w-full md:w-1/2 text-center md:text-left">
          <h1 className="text-5xl md:text-6xl">
            ...
            <br />
            <span className="text-xl md:text-2xl"> - Buy & Sell Toys Easily</span>
          </h1>

          <p className="mt-4 text-lg md:text-2xl text-gray-200 max-w-2xl">
            Find the best toy deals, buy/sell your toys, and join a trusted online shop.
          </p>
          ...
          <div className="mt-6 flex flex-wrap gap-4 justify-center md:justify-start md:font-semibold text-blue-700">
            ...
            {/* <span className="opacity-50"><FaRegDotCircle /></span> */}
          ...
          <div className="relative w-[600px] h-[400px] overflow-hidden rounded-xl">
            ...
            {images.map((src, i) => (
              <motion.div
                ...
                style={{
                  zIndex: images.length - i, // fixes transparent overlap
                }}
                initial={{ opacity: 0, scale: 1.1 }}
                animate={{
                  opacity: [0, 1, 1, 0],    // fade in → stay → fade out
                  scale: [1.1, 1.2],        // Ken Burns zoom
                }}
                transition={{
                  duration: IMAGE_DURATION,
                  delay: i * IMAGE_DURATION,
                  repeat: Infinity,
                  repeatDelay: TOTAL_CYCLE - IMAGE_DURATION, // perfect looping fix
                  ease: "easeInOut",
                }}
              >
                <Image
                  src={src} width={500} height={100}
                  className="w-full h-full object-cover rounded-xl"alt="Banner Image"
                />
